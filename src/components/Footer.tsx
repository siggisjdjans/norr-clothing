    ...
    <footer className="border-t border-neutral-200 bg-white">
      <div className="page-shell py-12">
        <div className="flex flex-col justify-between gap-10 sm:flex-row sm:items-start">
          ...
          <nav aria-label="Footer" className="flex flex-wrap gap-x-8 gap-y-4 text-sm"><Link href="/shop" className="link-draw">Collection</Link><Link href="/about" className="link-draw">About</Link><Link href="/contact" className="link-draw">Contact status</Link></nav>
        </div>
